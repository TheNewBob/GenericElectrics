...
PowerSource::PowerSource(double minvoltage, double maxvoltage, double maxpower, double internalresistance, unsigned int location_id, bool global)
...
unsigned int PowerSource::GetLocationId()
{
	return locationid;
}
