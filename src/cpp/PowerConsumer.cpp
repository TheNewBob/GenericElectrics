...
PowerConsumer::PowerConsumer(double minvoltage, double maxvoltage, double maxpower, unsigned int location_id, double standbypower, double minimumload, bool global)
...
unsigned int PowerConsumer::GetLocationId()
{
	return locationid;
}
