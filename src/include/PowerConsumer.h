...
public:
	 ...
	 */
	PowerConsumer(double minvoltage, double maxvoltage, double maxpower, unsigned int location_id, double standbypower = -1, double minimumload = 0.01, bool global = false);
